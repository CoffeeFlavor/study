...
//        }
        ...
        System.out.println("iterative sum done in: "+measureSumPerf(ParallelStreams::iterativeSum,10000000)+" msecs");
        System.out.println("parallel sum done in: "+measureSumPerf(ParallelStreams::parallelSum,10000000)+" msecs");
        System.out.println("rangeSum sum done in: "+measureSumPerf(ParallelStreams::rangeSum,10000000)+" msecs");
        System.out.println("parallelRange sum done in: "+measureSumPerf(ParallelStreams::parallelRangeSum,10000000)+" msecs");
